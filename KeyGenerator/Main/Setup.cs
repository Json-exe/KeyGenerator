...
public class Setup
{
    ...
    public void Main()
    {
        Console.WriteLine("Hello and welcome to KeyGenerator!\nThis is a Setup Wizard, which will guide you to setup your first Key-Pattern!\nIf you want to begin press any key.");
        Console.ReadKey();
        Console.WriteLine("This program will now ask you some questions to setup your first Key-Pattern.\nPress any key to continue.");
        Console.ReadKey();
        var name = AnsiConsole.Ask<string>("What is the name of your Key-Template? This will be used to identify your Key-Pattern for later use.");
        var patternLength = AnsiConsole.Ask("How long should the Key-Pattern be? (A part usually contains 5 Numbers/Letters, this is only used in random generators!)", 5);
        var patternSize = AnsiConsole.Ask("How many Numbers/Letters should be in one key part? (A part usually contains 5 Numbers/Letters, this is only used in random generators!)", 5);
        var separator = AnsiConsole.Ask("What should be the separator between the Key-Parts? This will be used to separate your key parts.", '-');
        ...
        for (var i = 0; i < key.PatternLength; i++)
        {
            ...
            var selection = AnsiConsole.Prompt(
                new SelectionPrompt<string>()
                    ...
                    .AddChoices("Static Text", "Random Numbers", "Random Letters", "Random Numbers and Letters (Mixed)"));
